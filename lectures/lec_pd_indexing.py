...
x = df.loc[['2020-01-02', '2020-01-03'], ['Close','Bday']]
print(x)

x = df.loc[['2020-01-02', '2020-01-03'],:]
print(x)
...
# Please select the values for the
# row indexes ['b','c','d','e'] for col1
...
# please select the values for the row indexes ['b','d','f','j']
# for col1 from the following dataframe
df = pd.DataFrame(
    {
        'col1': range(10),
        'col2': range(10, 20)
...
#put a [] around 'col1' will give a dataframe
print(result)
...
x = ser.iloc[0] # first element
x = ser.iloc[-1] #last element
...
#please select the values for the even-indexed row col2
#from the following dataframe
df = pd.DataFrame(
    {
        'col1': range(0, 20),
...
x = sorted_ser['b':] #equivalent to x = sorted_ser['b':'z']
print(x)
...
x = df[['Bday','Close']] #square bracket works
print(x)
